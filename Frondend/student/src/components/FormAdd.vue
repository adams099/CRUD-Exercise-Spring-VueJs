<template>
  <div class="d-flex justify-content-around">
    <form @submit.prevent="inputStudents" v-show="!success" class="border border-primary mt-5 col-8 p-5 rounded">
      <h4>Add Student</h4>
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          ...
          <input v-model="studentsData.soft_skill" type="text" class="form-control" id="softskill" required />
        </div>
      </div>
      <div class="form-group">
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <input v-model="studentsData.hard_skill" type="text" class="form-control" id="hardskill" required />
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <textarea v-model="studentsData.deskripsi_diri" class="form-control" id="selfdescriptions" rows="3"></textarea>
      </div>
